...
- 已生成 [[02_Projects/AI-Career-Transition/LLM训练机制系统学习文档]]；最小训练实践已完成数据、mask 与 shifted labels 代码审查，正在进入 TinyCausalLM forward 和 loss。
- 后续阶段统一从 [[02_Projects/AI-Career-Transition/当前阶段学习检查点]] 恢复；阶段完成后先生成持久系统学习文档，再滚动更新该固定检查点。
- 尚未取得实践脚本运行输出，也未完成 loss 下降、有效梯度、参数变化、checkpoint 恢复、测试、性能测量、阶段项目实现或独立工程验证。
