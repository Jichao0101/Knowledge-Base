...
topic: QAT工具教程
sources:
  - https://horizonrobotics.feishu.cn/wiki/LHZdwRneRi04AikWIv5c9VfjnJb
scope: 适用于 J6 平台 Horizon QAT 工具的入门与常规使用。
risks: 以工具使用说明为主，部分章节依赖外部在线文档；需按当前 plugin 版本核对 API。
source_task: 评估并将 J6 工具链候选文档提升到知识库
evidence:
  - 来源文档：03_Inbox/J6工具链/J6_QAT工具教程_对外.md
...
## 2.3 算子替换（使用 jit / jit-strip 模式不用考虑）
...
## 2.4 算子融合（使用 jit / jit-strip 模式不用考虑）
