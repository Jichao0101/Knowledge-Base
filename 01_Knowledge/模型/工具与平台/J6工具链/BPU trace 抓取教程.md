...
domain: 模型
topic: BPU trace 抓取教程
sources:
  - https://horizonrobotics.feishu.cn/wiki/XU1wwTvK1iBMnlk9u5JcY5cAnCe
scope: 适用于 J6/UCP 场景下进行 BPU trace 抓取与分析。
...
![](./BPU trace 抓取教程.assets/BPU_trace_抓取教程_image_001.png)
...
![](./BPU trace 抓取教程.assets/BPU_trace_抓取教程_image_002.png)

bpu_trace和ucp_trace进行了关联。
![](./BPU trace 抓取教程.assets/BPU_trace_抓取教程_image_003.jpg)
...
![](./BPU trace 抓取教程.assets/BPU_trace_抓取教程_image_004.png)
...
![](./BPU trace 抓取教程.assets/BPU_trace_抓取教程_image_005.png)
