...
1. **可视化**
  ...
  <grid cols="2">
    <column width="50">
      **Pyramid**
      ![](./J6EM_OE_Pyramid_Resizer输入部署说明-v2.3_对外.assets/J6EM_OE_Pyramid_Resizer输入部署说明-v2.3_对外_image_001)

    </column>
    <column width="50">
      **Resizer**
      ![](./J6EM_OE_Pyramid_Resizer输入部署说明-v2.3_对外.assets/J6EM_OE_Pyramid_Resizer输入部署说明-v2.3_对外_image_002)
...
<grid cols="2">
  <column width="50">
    **Pyramid**
    ![](./J6EM_OE_Pyramid_Resizer输入部署说明-v2.3_对外.assets/J6EM_OE_Pyramid_Resizer输入部署说明-v2.3_对外_image_003)


  </column>
  <column width="50">
    **Resizer**
    ![](./J6EM_OE_Pyramid_Resizer输入部署说明-v2.3_对外.assets/J6EM_OE_Pyramid_Resizer输入部署说明-v2.3_对外_image_004)
