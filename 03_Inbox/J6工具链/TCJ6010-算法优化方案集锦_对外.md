...
<grid cols="2">
  <column width="46">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_001.png)

  </column>
  <column width="53">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_002.png)
...
方案1与方案2思想一样
![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_003.jpg)
...
![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_004.png)

方式二：算法上去除Inverse sigmoid算子（需重训，此方案需要验证对浮点的影响）。可参考算法bevformer的decoder:
<grid cols="2">
  <column width="49">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_005.png)

  </column>
  <column width="50">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_006.png)

  </column>
</grid>

为表示更加精确，可以对sigmoid的输入做clamp：
![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_007.png)
...
![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_008.jpg)
...
<grid cols="2">
  <column width="46">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_009.png)

  </column>
  <column width="53">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_010.png)
...
若使用时存在CPU的bitshift或add时，可以开启VPU使其运行到VPU中，若不需要VPU或双int16存在性能问题时则可以通过修改plugin源码方式自动做拆分，需要将红框后面的减法去掉：
![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_011.jpg)
...
<grid cols="2">
  <column width="46">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_012.png)

  </column>
  <column width="53">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_013.png)
...
<grid cols="3">
  <column width="34">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_014.png)

  </column>
  <column width="40">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_015.png)

  </column>
  <column width="25">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_016.png)
...
<grid cols="2">
  <column width="50">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_017)

  </column>
  <column width="49">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_018)
...
<grid cols="2">
  <column width="40">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_019.png)

  </column>
  <column width="59">
    ![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_020.png)
...
![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_021.png)
...
![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_022.png)
...
![](./TCJ6010-算法优化方案集锦_对外.assets/TCJ6010-算法优化方案集锦_对外_image_023.jpg)
